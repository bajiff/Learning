...
function tambah($data)
{
    ...
    $query = "INSERT INTO cahaya_surga (nama, kelas, divisi, gambar) VALUES ('$nama', '$kelas', '$divisi', '$gambar')";
...
function regist($data){
    ...
    $result = mysqli_query($conn_cs, "SELECT username FROM users WHERE username = '$username'");
    if(mysqli_fetch_assoc($result)){
        echo "<script>alert('Username Sudah Terdaftar :D');</script>";
        return false;
    }
